...
base_command = "./tc.out -c ../../../configs/iiswc/PIMeval_BitSerial_Rank4.cfg -v t -i \"../Dataset/v18772_symetric\" -a SERIAL"

# Output CSV file
csv_file = "pim_serial_results.csv"
...
# Execute command
command = f"{base_command} > result_serial.txt"
print(f"Executing: {command}")

# Run the command
subprocess.run(command, shell=True)

# Read the result_serial file
output_file = "result_serial.txt"
